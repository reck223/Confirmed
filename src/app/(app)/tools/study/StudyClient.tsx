      ...
      {showNewDeck && (
        <div className="modal-open" style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: '20px 16px' }}>
          <div style={{ width: '100%', maxWidth: 560, borderRadius: 24, background: '#111', border: '1px solid rgba(255,255,255,0.08)', padding: '28px 24px', animation: 'scaleIn 0.2s ease both', maxHeight: '85dvh', overflowY: 'auto' }}>
            ...
            <button onClick={handleCreateDeck} disabled={!deckName.trim() || saving} style={{ width: '100%', padding: '14px 0', borderRadius: 16, background: deckName.trim() ? `linear-gradient(135deg,${deckColor},${deckColor}aa)` : 'rgba(255,255,255,0.05)', border: 'none', fontSize: 14, fontWeight: 800, color: deckName.trim() ? '#0A0A0A' : 'rgba(255,255,255,0.28)', cursor: deckName.trim() ? 'pointer' : 'not-allowed', fontFamily: 'Satoshi,sans-serif' }}>
      ...
      {editCard && (
        <div className="modal-open" style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: '20px 16px' }}>
          <div style={{ width: '100%', maxWidth: 560, borderRadius: 24, background: '#111', border: '1px solid rgba(255,255,255,0.08)', padding: '28px 24px', animation: 'scaleIn 0.2s ease both', maxHeight: '85dvh', overflowY: 'auto' }}>
            ...
            <button onClick={handleUpdateCard} disabled={!editFront.trim() || !editBack.trim() || saving} style={{ width: '100%', padding: '14px 0', borderRadius: 16, background: editFront.trim() && editBack.trim() ? `linear-gradient(135deg,${activeDeck.color},${activeDeck.color}aa)` : 'rgba(255,255,255,0.05)', border: 'none', fontSize: 14, fontWeight: 800, color: editFront.trim() && editBack.trim() ? '#0A0A0A' : 'rgba(255,255,255,0.28)', cursor: editFront.trim() && editBack.trim() ? 'pointer' : 'not-allowed', fontFamily: 'Satoshi,sans-serif' }}>
      ...
      {showNewCard && (
        <div className="modal-open" style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: '20px 16px' }}>
          <div style={{ width: '100%', maxWidth: 560, borderRadius: 24, background: '#111', border: '1px solid rgba(255,255,255,0.08)', padding: '28px 24px', animation: 'scaleIn 0.2s ease both', maxHeight: '85dvh', overflowY: 'auto' }}>
            ...
            <button onClick={handleCreateCard} disabled={!cardFront.trim() || !cardBack.trim() || saving} style={{ width: '100%', padding: '14px 0', borderRadius: 16, background: cardFront.trim() && cardBack.trim() ? `linear-gradient(135deg,${activeDeck.color},${activeDeck.color}aa)` : 'rgba(255,255,255,0.05)', border: 'none', fontSize: 14, fontWeight: 800, color: cardFront.trim() && cardBack.trim() ? '#0A0A0A' : 'rgba(255,255,255,0.28)', cursor: cardFront.trim() && cardBack.trim() ? 'pointer' : 'not-allowed', fontFamily: 'Satoshi,sans-serif' }}>
