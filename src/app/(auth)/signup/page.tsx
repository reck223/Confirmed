    ...
    <div className="relative z-10 min-h-screen flex items-center justify-center px-5">
      ...
      <div style={{ width: '100%', maxWidth: 340, position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 40 }}>
          ...
          <p style={{ marginTop: 16, fontSize: 13, fontWeight: 300, color: '#666', fontStyle: 'italic' }}>Join a community that holds you to your word.</p>
        </div>
        ...
        {/* Email form */}
        <form onSubmit={handleSignUp} style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 14 }}>
          <input type="text" placeholder="Full name" value={name} onChange={e => setName(e.target.value)} required className="cc-input" />
          <input type="email" placeholder="Email address" value={email} onChange={e => setEmail(e.target.value)} required className="cc-input" />
          <input type="password" placeholder="Create password" value={password} onChange={e => setPassword(e.target.value)} required className="cc-input" />
